defmodule CetaceaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CetaceaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CetaceaWeb.Gettext, "errors", msg, opts)
    end
  end
